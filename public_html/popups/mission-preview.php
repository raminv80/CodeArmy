...
<div class="find-mission-full-container">
    ...
    <div class="find-mission-comment-box">
      ...
      <div class="find-mission-comment-box-right">
        ...
        <div class="fmcb-right-textarea">
          <textarea rows="3">Ask a question</textarea>
        </div>
        <input type="submit" value="Submit" class="lnkimg" />
      </div>
  ...
  <div class="find-mission-right-col">
    ...
    <div class="find-mission-right-block">
      ...
      <div class="captainame">Mr.ProductOwner</div>
      <div class="captainrank">99 Captain</div>
      <div class="rankicons"> <img src="/public/images/codeArmy/mission/newbie-icon.png" /> <img src="/public/images/codeArmy/mission/newbie-icon.png" /> <img src="/public/images/codeArmy/mission/newbie-icon.png" /> </div>
    </div>
    <div class="find-mission-right-block">
      <div class="right-col-title-bg">Pre-Requisites</div>
      <div class="prereqicons">
        <div class="prereqicon"><img src="/public/images/codeArmy/mission/ps-icon.png" />
          <p>10</p>
        </div>
        <div class="prereqicon"><img src="/public/images/codeArmy/mission/ps-icon.png" />
          <p>10</p>
    ...
    <div class="find-mission-right-block">
      ...
      <div class="find-mission-material-row">
        <div class="attach-file-tools"> <a href="#"><img src="/public/images/codeArmy/mission/fileicon.png" class="fileicon" /></a> <span class="filename"><a href="#">Project-brief.ppt</a></span> <span class="filesize">(250kb)</span> </div>
      </div>
      <div class="find-mission-material-row">
        <div class="attach-file-tools"> <a href="#"><img src="/public/images/codeArmy/mission/fileicon.png" class="fileicon" /></a> <span class="filename"><a href="#">Project-brief.ppt</a></span> <span class="filesize">(250kb)</span> </div>
      </div>
