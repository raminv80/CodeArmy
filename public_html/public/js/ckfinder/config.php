...
function CheckAuthentication()
{
	...
	$query = "SELECT user_data FROM ci_sessions WHERE session_id = '$ci_session_id' LIMIT 1";
	...
	if($data['is_logged_in']== 'true'){
		...
		$baseUrl = '/ckfinder/userfiles/' . $user_id . '/';
...
$data = unserialize($row['user_data']);
$user_id = $data['user_id'];
$baseUrl = '/public/js/ckfinder/userfiles/' . $user_id . '/';
