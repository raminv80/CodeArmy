...
<body>
	<div id="header">
		<div class="inner">
			<div class="top">
				<a href="javascript: void(0);" class="contact contact_button">Contact us</a> |
                <a href="/blog" class="contact" target="_blank">Blog</a>
          ...
          <li><a href="https://twitter.com/#!/Code_Army" class="twitter" target="_blank">Twitter</a></li>
			...
			<div class="holder">
				...
				<ul class="main-nav">
					<li><a href="#wrapper">Overview</a></li>
				...
				<div class="holder">
					<div class="video-holder">
                        ...
                        <!--<object style="height: 390px; width: 640px">
                        	<param name="movie" value="http://www.youtube.com/v/5Q8VQmd-vjg?version=3&feature=player_profilepage">
                            <param name="wmode" value="opaque" />
                            <param name="allowFullScreen" value="true">
                            <param name="allowScriptAccess" value="always">
                            <embed src="http://www.youtube.com/v/5Q8VQmd-vjg?version=3&feature=player_profilepage" wmode="opaque" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="640" height="360">
                        </object>-->
                        <iframe class="youtube-player" type="text/html" width="640" height="360" src="http://www.youtube.com/embed/5Q8VQmd-vjg?wmode=opaque" frameborder="0"></iframe>
					</div>
					<div class="text-holder">
						<h2>new work-lifestyle</h2>
						<p>Simply speaking - getting the right people, at the right time, for the right price, who can actually do the job! Be at the top of your game!</p>
					</div>
				</div>
			</div>
            <!--start up-->
				...
				<div class="holder" id="owner">
					<div class="frame">
						...
						<div class="sign-block">
							<div class="text">
								<h3>Units available for hire <span class="mark">24/7</span></h3>
								<p>Take on a whole contract, or a sub-section of it that are relevant to your skills-Code Ar.my offers flexibility for you to excel in your specialized area.</p>
							</div>
							<div class="btn-holder">
								<span class="beta">BETA</span>
								<a href="javascript: void(0);" class="btn register">SIGN UP</a>
							</div>
						</div>
						<div class="img-row">
						...
						<div class="text-row">
							<div class="block">
								<h4>Talent &amp; Skill Rating</h4>
								<p>Take on a whole contract, or a sub-section of it that are relevant to your skills. Code Ar.my offers flexibility for you to excel in your specialized area. You control your workload and the jobs you wantto work on</p>
							</div>
				...
				<div class="holder" id="talent">
					<div class="frame">
						...
						<div class="row">
							<div class="sign-block">
								<div class="text">
									<h3>Freedom to work on what you want!</h3>
									<p>Take on a whole contract, or a sub-section of it that are relevant to your skills-Code Ar.my offers flexibility for you to excel in your specialized area.</p>
								</div>
								<div class="btn-holder">
									<span class="beta">BETA</span>
						...
						<div class="text-row">
							...
							<div class="block center">
								<div class="img-holder">
									<img src="/public/images/codeArmy/home/icon-level.png" alt="image description" width="149" height="85" />
								</div>
								<h4>Level Up</h4>
								<p>Take on a whole contract, or a sub-section of it that are relevant to your skills. Code Ar.my offers flexibility for you to excel in your specialized area. You control your workload and the jobs you wantto work on</p>
							</div>
			...
			<div class="nav-holder">
				<div class="frame">
					<ul>
                        ...
                        <li><a href="/blog" class="contact">Blog</a></li>
						<li>
							<ul class="social-networks">
								<li><a href="http://www.facebook.com/CodeArmyHQ" class="facebook">Facebook</a></li>
								<li><a href="http://www.linkedin.com/company/code_army" class="linkedin">LinkedIn</a></li>
								<li><a href="https://twitter.com/#!/Code_Army" class="twitter">Twitter</a></li>
							</ul>
						</li>
					</ul>
				</div>
...
<div id="register-box">
    ...
    <img src="/public/images/codeArmy/loader4.gif" style="position:absolute; top:42px; right:451px; display:none" id="reg-ajax" />
	<span id="reg-error" class="error" style="position:absolute;left:167px; top:67px;"></span>
    <span style="position:absolute; right:414px; top:94px;">Username</span>
    ...
    <a href="javascript: void(0)" id="register-submit" class="CAbutton" style="position:absolute; right:85px; top:198px; color:#CCC">Sign up</a>
    <?php echo form_close(); ?>
</div>
<div id="contact">
<div class="contact_info">
    	<p>Code Gamification Sdn Bhd<br />Suite 29-6, Boulevard Office, <br />Mid Valley City, Lingkaran Syed Putra,<br />59200 Kuala Lumpur, Malaysia.</p>
    ...
    <?php echo form_open('contact', array('id'=>'contact-form')); ?>
        <img src="/public/images/codeArmy/loader4.gif" style="position:absolute; top:28px; right:331px; display:none;" id="contact-ajax" />
        <span style="position:absolute; left:373px; top:60px;">Name</span>
        ...
        <select name="subject" id="contact-subject" style="top:163px;left:450px;display:block;width:315px;height:22px;position:absolute;border:none;">
          ...
          <option value="Tallents">Tallents</option>
    ...
    <?php echo form_close(); ?>
  <div style="position: absolute;top: 335px;left:450px;font-size:12.96pt;">WWW.CodeAr.my</div>
  <a href="javascript: void(0)" id="contact-submit" class="CAbutton" style="position:absolute; right:5px; top:300px; color:#CCC">Submit</a>
</div>
