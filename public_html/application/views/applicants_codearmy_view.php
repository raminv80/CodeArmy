...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<!-- Page start -->
		<div class="applicants-container" class="span10 offset1">
		  <div id="block-applicants-header">
		    <div class="block-header clearfix">
		      <h3>Troopers (<?=count($troops)?>)</h3>
		    </div>
		    <div id="achievements-header-text clearfix">Here is list of bidders on your mission A.K.A troopers. The green circles next to each trooper shows percentage of match between trooper's skill set and your mission skill requirements.</div>
		  </div>
