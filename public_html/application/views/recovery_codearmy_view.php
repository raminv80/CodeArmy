...
<div id="Recovery_MainContent" class="MainContent">
  <div id="dialog-holder">
  	<div class="content">
        ...
        <input type="text" disabled name="email" id="email" value="<?php echo $this->input->post('email'); ?>" autofocus />
        <div style="position:absolute;top:207px;left:334px;"><a class="CAbutton" href="/home">Back</a></div>
        <?php }else{ ?>
        <p style=" position:absolute; top:70px; left:33px; width:492px; line-height:20px;">Well, aren't we a little forgetfull now, lucky you that the commander isn't in. Give me your email address and i'll send you the new password.</p>
