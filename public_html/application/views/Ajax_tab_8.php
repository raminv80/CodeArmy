						<div class="tab-holder">
							<div class="tab-frame">
								<div class="content">
                                    ...
                                    <?php endforeach;?>
                                    </ul></td><td width="120">status here</td></tr><tr><td style="text-align:left"><a href="#">Add a new project</a><br></td><td width="120">status here</td></tr>
                                   </table><div id="addnewproject"><a href="http://ver2.workpad.my/#addnewPrj">add new projects</a></div>
								</div></div>
							</div>
						</div>