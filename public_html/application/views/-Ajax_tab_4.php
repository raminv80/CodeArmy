      ...
      <ul id="column1" class="column">
        <li class="widget color-red">
          ...
          <div class="widget-content">
            ...
            <tr class="story-title1">
              ...
              <td><span class="type_<?php echo $work_list_inProgress[$i]['type'] ?>"> <?php echo $work_list_inProgress[$i]['title'] ?> </span></td>
        ...
        <li class="widget color-yellow">
          ...
          <div class="widget-content">
            ...
            <tr class="story-title1">
              ...
              <td><span class="type_<?php echo $work_list_done[$i]['type'] ?>"> <?php echo $work_list_done[$i]['title'] ?> </span></td>
        ...
        <li class="widget color-blue">
          ...
          <div class="widget-content">
            ...
            <table class="myTable1" cellpadding="0" cellpadding="0" class="listing" width="100%">
            <tr>
              <th align="left">User Story Title</th>
              <th width="6%">Points</th>
              <th width="7%">Cash</th>
            </tr>
            <?php $c = count($work_list_signoff); for($i = 0; $i < $c; $i++): ?>
            <tr class="story-title1">
              <td><span class="type_<?php echo $work_list_signoff[$i]['type'] ?>"> <?php echo $work_list_signoff[$i]['title'] ?> </span></td>
              <td><?php echo $work_list_signoff[$i]['points'] ?></td>
              <td>RM <?php echo $work_list_signoff[$i]['cost'] ?></td>
            </tr>
            <tr>
              <td colspan="3" class="details"><div class="test">
                  <p> <?php echo $work_list_signoff[$i]['description'] ?> </p>
                  <br />
                  <a href="/story/<?php echo $work_list_signoff[$i]['work_id'] ?>">More details</a> </div></td>
            </tr>
            <?php endfor; ?>
            </table>
            <?php }
