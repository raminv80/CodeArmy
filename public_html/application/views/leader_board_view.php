                                            ...
                                            <ol style="list-style-type:none;">
                                                ...
                                                <li style="width: 300px;" id="m<?php echo $leader['user_id'];?>">
                                                    ...
                                                    <div class="image-holder">
                                                        <a href="/user/<?php echo $leader['user_id'];?>"><img src="<?php echo ($leader['avatar'])? '/public/'.$leader['avatar'] : 'http://www.gravatar.com/avatar/'.md5( strtolower( trim( $leader['email'] ) ) );?>" alt="profile picture" class="alignleft" width="80" height="80" /></a>
                                                    </div>
