...
<div id="inbox-content-area"> 
  ...
  <div id="inbox-area">
    <div id="inbox-top-bar">
      ...
      <div id="arrow-left"><a href="/messages/important/<?=($current>0)?$current-1:$current?>"><img src="/public/images/codeArmy/messages/arrow-left.png" /></a></div>
      <div id="arrow-right"><a href="/messages/important/<?=(($current+1) < ceil($total/$limit))?$current+1:$current?>"><img src="/public/images/codeArmy/messages/arrow-right.png" /></a></div>
    </div>
    ...
    <div id="inbox-top-bar">
      ...
      <div id="msg-no"><?=$current+1?> to <?=min($limit*($current+1), $total)?> of <?=$total?></div>
      <div id="arrow-left"><a href="/messages/important/<?=($current>0)?$current-1:$current?>"><img src="/public/images/codeArmy/messages/arrow-left.png" /></a></div>
      <div id="arrow-right"><a href="/messages/important/<?=(($current+1) < round($total/$limit))?$current+1:$current?>"><img src="/public/images/codeArmy/messages/arrow-right.png" /></a></div>
    </div>
  </div>
</div>
