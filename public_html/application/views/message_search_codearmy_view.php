...
<div id="inbox-content-area"> 
  ...
  <div id="inbox-area">
    <div id="inbox-top-bar">
      <div id="back"><a title="Goto previous page" href="/messages/search/<?=($current>0)?$current-1:$current?>">Back</a></div>
    ...
    <div class="inbox-rows">
      <div class="title-row">
        <div id="select-all">Select <a title="Select all messages" title="Select all messages" href="javascript: selectAll()">all</a>/<a title="Deselect all messages" title="Deselect all messages" href="javascript: selectNone()">none</a></div>
